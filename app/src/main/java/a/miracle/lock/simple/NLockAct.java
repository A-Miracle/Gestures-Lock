...
import a.miracle.lock.widget.NLockSmallView;

import a.miracle.lock.widget.NLockView;

/**
 * Created by A Miracle on 2016/8/18.
 */
public class NLockAct extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_nlock);
